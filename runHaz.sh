...
awk '{print $2, $1, $3}' $infile | xyz2grd -R -I0.6 -Gtmp.grd
...
makecpt -Cseis -T0.3/5.2/0.2 -I >tmp.cpt
...
psscale -D2.5/-1.0/6.0/0.30h -B0.8/:: -Ctmp.cpt -I -O >> $out
