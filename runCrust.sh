...
proj="M17"
region="30/80/10/45"
infile=$(echo "sediment_thickness_km.xyz")
...
awk '{print $1, $2, $3}' $infile | xyz2grd -R -I0.6 -Gtmp.grd
...
makecpt -Cseis -T-2/$max/1 -I >tmp.cpt
...
psscale -D3.8/-1.0/8.0/0.30h -B5:Sedimentary_Thickness:/:km: -Ctmp.cpt -I -O >> $out
